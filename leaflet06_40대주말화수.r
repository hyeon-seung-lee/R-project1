#2018년 40대, 주말 - (화,수) 차이가 가장 큰 곳을 나타내기
rm(list = ls())
...
flow18_weekend <-flow18[,c(6,185:196,437:448,534:536)]
...
#2018년 40대 화요일 수요일
load("save/flow18.rdata")
flow18_tuewedn <-flow18[,c(6,161:172,413:424,534:536)]
...
leaflet(flow18_weekend_total) %>% addTiles() %>%
  ...
  addCircles(lng = ~lon, lat = ~lat, weight = 1,
             ...
             color = ~flow_color(group), fillOpacity = 0.2, group = '40대 주말') %>% 
  ...
  addLayersControl(       # 옵션 컨틔롤
    ...
    overlayGroups = c("상권","서울 명소","지하철역", 
                      "40대 주말", "40대 화수", "40대 주말-화수", "40대 화수-주말"),
